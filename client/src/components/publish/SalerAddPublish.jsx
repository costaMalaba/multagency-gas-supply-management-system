    ...
    try {
      await axios.post(
        ...
        if (res.data.Status === "Success") {
          navigate(`/dashboard/saler/publish/view/${inputs.creator}`);
          toast.success(res.data.Message);
          console.log(res.data)
        } else {
          navigate("/dashboard/saler/publish");
    ...
    <div className="conatiner-fluid py-5">
      ...
      <div className="card bg-light border-0 col-6 shadow-lg">
        <div className="card-header text-center bg-info">
          <h1 className="py-3 fs-2">Add order for Retailer</h1>
        </div>
...
export default SalerAddPublish;
